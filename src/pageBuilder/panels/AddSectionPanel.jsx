    ...
    return (
        <div className="pb-editor">
            <div className="pb-editor-header">
                <button className="pb-back-btn" onClick={onCancel} title="Cancel">
                    <ChevronLeftIcon />
                </button>
                <div className="pb-breadcrumb">
                    <button className="pb-breadcrumb-btn" onClick={onCancel}>
                        Page
                    </button>
            ...
            <div className="pb-editor-body">
                ...
                <p className="pb-add-section-hint">Choose a section type to add to the page</p>
