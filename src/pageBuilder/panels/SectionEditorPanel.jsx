...
import { SortableItemRow, ItemRowClone } from "../dndRows"
import { ChevronLeftIcon, ChevronRightIcon, PlusIcon, TrashIcon, PaintbrushIcon, FileTextIcon, ListIcon } from "../icons"
    ...
    return (
        <div className="pb-accordion">
            <button className={`pb-accordion-header${open ? " open" : ""}`} onClick={onToggle}>
                ...
                <span className={`pb-accordion-chevron${open ? " open" : ""}`}>
                    <ChevronRightIcon />
                </span>
            </button>
    ...
    return (
        <div className="pb-editor">
            <div className="pb-editor-header">
                <button className="pb-back-btn" onClick={onBack} title="Back to sections">
                    <ChevronLeftIcon />
                </button>
                <div className="pb-breadcrumb">
                    <button className="pb-breadcrumb-btn" onClick={onBack}>
                        Page
                    </button>
            ...
            <div className="pb-delete-area">
                <button className="pb-delete-btn" onClick={onDeleteSection}>
